<h3>{{ trans('editorial.guidance.heading') }}</h3>
<ul class="nav nav-sidebar">
    <li><a href="#" data-toggle="collapse" data-target="#guidance"
           aria-expanded="false" aria-controls="guidance">{{ trans('editorial.guidance.toggle_text') }} <span class="caret"></span></a>
